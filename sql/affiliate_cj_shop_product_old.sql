...
-- ----------------------------
-- Table structure for affiliate_cj_shop_product_old
-- ----------------------------
DROP TABLE IF EXISTS `affiliate_cj_shop_product_old`;
CREATE TABLE `affiliate_cj_shop_product_old`  (
  ...
  `ad_id` int NULL DEFAULT NULL COMMENT '广告商关联id',
  ...
  `custom_label1` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `custom_label2` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `custom_label3` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  ...
  `item_list_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  ...
  `mobile_link` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
) ENGINE = InnoDB AUTO_INCREMENT = 1757964 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
