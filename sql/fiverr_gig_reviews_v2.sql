...
-- ----------------------------
-- Table structure for fiverr_gig_reviews_v2
-- ----------------------------
DROP TABLE IF EXISTS `fiverr_gig_reviews_v2`;
CREATE TABLE `fiverr_gig_reviews_v2`  (
...
) ENGINE = InnoDB AUTO_INCREMENT = 23 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Fiverr网站Gig表' ROW_FORMAT = Dynamic;
